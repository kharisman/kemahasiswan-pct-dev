                                ...
                                <div class="card shadow mb-4">
                                    <div class="col mb-3">
                                        <div class="card">
                                            <div class="card-body">  
                                    @if ($projects->isEmpty())
                                        <p>Kamu belum buat project.</p></div>
                                            </div><a class="nav-link" href="{{route('create_project')}}">Buat project baru</a>
                                        </div>
                                    </div>
                                     @else
                                                <h5 class="card-title"></h5>@foreach($projects as $project){{ $project->name }}</h5>
                                                <p class="card-text"></p>{!! $project->notes !!} @endforeach
