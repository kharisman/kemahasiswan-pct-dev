            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            <label for="pword2">Ulangi Password</label>
                            <input type="password" id="pword2" class="form-control form-control-lg">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <input type="submit" value="Register" class="col-12 btn btn-primary btn-lg px-5">
                        </div>
                    </div>
                    <div class="col-12">
                      <a href="register-iduka.html" class="btn btn-info px-5 mt-5 ml-3 btn-lg">Daftar Sebagai Iduka</a>
                    </div>
                </div>
            </div>  
          </div>
