        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <li class="nav-item">
                            <a class="nav-link" href="#register_iduka" data-toggle="tab">{{ __('Iduka') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="#register_internship" data-toggle="tab">{{ __('Internship') }}</a>
                        </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="register_iduka">
                            <div class="row align-items-end justify-content-center text-center">
                                <div class="col-lg-7">
                                    <h2 class="mb-0">Register</h2>
                                    <p>Sebagai Iduka</p>
