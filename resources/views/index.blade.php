...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('{{asset('landingpage/images/alamat_palcomtech.png')}}');">
        ...
        <div class="row mb-5 justify-content-center text-center">
          <div class="col-lg-6 mb-5">
            <h2 class="section-title-underline mb-3">
              <span>Project & open recruitment populer</span>
            </h2>
            <p>Project dan open recruitment terhits DiPalembang </p>
          </div>
        </div>
    ...
    <div class="section-bg style-1" style="background-image: route('images/about_1.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
  ...
  <div class="site-section">
    ...
    <div class="site-section ftco-subscribe-1" style="background-image: route('images/bg_1.jpg')">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-7">
