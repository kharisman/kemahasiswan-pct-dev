...
<head>
  <title>Plaocmtech x iduka</title>
  <meta charset="utf-8">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
        ...
        <div class="d-flex align-items-center">
          <div class="site-logo">
            <a href="index.html" class="d-block">
              <img src="images/Logo-1.jpg" alt="Image" class="img-fluid" height="70" width="55">
            </a>
          </div>
          <div class="mr-auto">
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('images/alamat_palcomtech.png');">
        <div class="container">
          <div class="row align-items-center">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Kurikulum sesuai kebutuhan</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit morbi hendrerit elit</p>
                <p><a href="#" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div> 
        ...
        <div class="row mb-5 justify-content-center text-center">
          <div class="col-lg-6 mb-5">
            <h2 class="section-title-underline mb-3">
              <span>Tempat Magang Populer</span>
            </h2>
            <p>Cari tempat magang terhits diPalembang </p>
          </div>
        </div>
  ...
  <div class="site-section">
    ...
    <div class="footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
            <p class="mb-4"><img src="images/Logo-1.jpg" alt="Image" class="img-fluid" height="70" width="55"></p>
            <p>Kerja sama Palcomtech dan iduka</p>  
            <p><a href="#">lebih lanjut</a></p>
          </div>
          <div class="col-lg-3">
            ...
            <ul class="list-unstyled">
                ...
                <p></p>
                <li><a href="https://palcomtech.ac.id/">palcomtech.ac.id</a></li>
            ...
            <div class="copyright">
                <p>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                     &copy;<script>document.write(new Date().getFullYear());</script> Institut Teknologi dan Bisnis PalComTech <i class="icon-heart" aria-hidden="true"></i> All rights reserved. 
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
            </div>
          </div>
