                    ...
                    <table class="table text-center">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>xxxx</td>
                            <td>xxxx</td>
                            <td><a href="" class="btn btn-disable btn-sm btn-warning">On Going</a></td>
                          </tr>
                          <tr>
                            <th scope="row">2</th>
                            <td>xxxx</td>
                            <td>xxxx</td>
                            <td><a href="" class="btn btn-disable btn-sm btn-success">Success</a></td>
                          </tr>
                          <tr>
                            <th scope="row">3</th>
                            <td>xxxx</td>
                            <td>xxxx</td>
                            <td><a href="" class="btn btn-disable btn-sm btn-danger">Reject</a></td>
                          </tr>
                        </tbody>
                      </table>
                </div>
