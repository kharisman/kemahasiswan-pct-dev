...
<head>
  ...
  <link href="landingpage/css/jquery.mb.YTPlayer.min.css" media="all" rel="stylesheet" type="text/css">
  ...
  <div class="site-wrap">
        ...
        <div class="d-flex align-items-center">
          <div class="site-logo">
            <a href="index.html" class="d-block">
              <img src="landingpage/images/logo.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li>
                  <a href="courses.html" class="nav-link text-left">Apply Project</a>
                </li>
              </ul>                                                                                                                                                                                                                                                                                          </ul>
            </nav>
          </div>
    ...
    <div class="site-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5">
                  <div class="card-body color-b" style="border-radius: 10px;">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label for="username">Username</label>
                            <input type="text" id="username"  class="form-control form-control-sm" placeholder="input username ...">
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="email">Email</label>
                            <input type="email" id="email" class="form-control form-control-sm" placeholder="input email ...">
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="pword">Password</label>
                            <input type="password" id="pword" class="form-control form-control-sm" placeholder="input password ...">
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="pword2">Re-type Password</label>
                            <input type="password" id="pword2" class="form-control form-control-sm" placeholder="retype password ...">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <a href="dashboard.html" class="btn color-a btn-sm px-5">Register</a>
    ...
    <div class="footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
            <p class="mb-4"><img src="landingpage/images/logo.png" alt="Image" class="img-fluid"></p>
