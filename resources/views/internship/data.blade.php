            ...
            <div class="row">
                    <div class="card">
                        ...
                        <div class="card-body">
                                <div class="row mb-3 text-end">
                                    <label for="nama" class="col-sm-4 col-form-label text-start">Nama</label>
                                    <div class="col-sm-8">
                                        <input id="nama" class="form-control" type="text" name="nama" placeholder="nama..." required>
                                    </div>
                                </div>
                                <div class="row mb-3 text-end">
                                    <label for="jenis_kelamin" class="col-sm-4 col-form-label text-start">Jenis Kelamin</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="row mb-3 text-end">
                                    <label for="foto" class="col-sm-4 col-form-label text-start">Foto</label>
                                    <div class="col-sm-8">
                                      <input id="foto" class="form-control" type="file" name="foto" required>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-warning btn-sm text-center">Submit</button>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                    ...
                    <div class="collapse" id="collapseExample1">
                      <div class="card card-body">
                        <div class="row mb-3 text-end">
                            <label for="foto" class="col-sm-4 col-form-label text-start">Nomor Telepon</label>
                            <div class="col-sm-8">
                              <input id="foto" class="form-control" type="text" placeholder="nomor telepon ..." name="foto" required>
                            </div>
                        </div>
                        <div class="row mb-3 text-end">
                            <label for="foto" class="col-sm-4 col-form-label text-start">Media Sosial 1</label>
                            <div class="col-sm-8">
                              <input id="foto" class="form-control" type="text" placeholder="url ..." name="foto" required>
                            </div>
                        </div>
                        <div class="row mb-3 text-end">
                            <label for="foto" class="col-sm-4 col-form-label text-start">Media Sosial 2</label>
                            <div class="col-sm-8">
                              <input id="foto" class="form-control" type="text" placeholder="url ..." name="foto" required>
                            </div>
                        </div>
                        <div class="row mb-3 text-end">
                            <label for="foto" class="col-sm-4 col-form-label text-start">Media Sosial 3</label>
                            <div class="col-sm-8">
                              <input id="foto" class="form-control" type="text" placeholder="url ..." name="foto" required>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="collapse" id="collapseExample2">
                      <div class="card card-body">
                        <div class="row mb-3 text-end">
                            <label for="foto" class="col-sm-4 col-form-label text-start">Dokumen 1</label>
                            <div class="col-sm-8">
                              <input id="foto" class="form-control" type="file" name="foto" required>
                            </div>
                        </div>
                        <div class="row mb-3 text-end">
                            <label for="foto" class="col-sm-4 col-form-label text-start">Dokumen 2</label>
                            <div class="col-sm-8">
                              <input id="foto" class="form-control" type="file" name="foto" required>
                            </div>
                        </div>
                        <div class="row mb-3 text-end">
                            <label for="foto" class="col-sm-4 col-form-label text-start">Dokumen 3</label>
                            <div class="col-sm-8">
                              <input id="foto" class="form-control" type="file" name="foto" required>
                            </div>
                        </div>
