...
<div class="custom-breadcrumns border-bottom">
    <div class="container">
        ...
        <a href="courses.html">Projec5</a>
</div>

<div class="news-updates">
    <div class="container">
        
        <form class="form-inline mb-4" action="{{ route('project') }}" method="GET">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                 <div class="section-heading">
                    @if ($filter === 'terbaru')
                        <h2 class="text-black">Project Terbaru</h2>
                    @elseif ($filter === 'populer')
                        <h2 class="text-black">Project Terpopuler</h2>
                    @else
                        <h2 class="text-black">Semua project</h2>
                    @endif
                </div>
                <div class="row">
                    <div class="col-lg-12">
